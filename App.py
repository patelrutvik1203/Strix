...
# SCREEN: TRADINGVIEW CHARTS TERMINAL
    ...
    # Workaround: Use BSE (Bombay Stock Exchange) symbol prefix inside the embedded widget.
    # BSE symbols are fully allowed for free embeddings on third-party domains under SEBI/BSE data guidelines!
