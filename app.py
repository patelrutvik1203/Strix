...
import config
from utils import logger, bsm_greeks, calculate_max_pain, calculate_strategy_payoff
from broker_manager import BrokerManager
from market_data import MarketDataEngine, LiveDataFetcher
...
broker_5p = st.session_state.broker_manager.broker_clients["5Paisa API"]
...
# Fetch live index coordinates FIRST to resolve dependencies
